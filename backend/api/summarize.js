...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const prompt = `You will be given a list of tasks below... [rest of your prompt here]\n\nTasks:\n${tasksParagraph}\n\nSummary:\n`;

    const response = await axios.post(
      'https://api-inference.huggingface.co/models/facebook/bart-large-cnn',
      { inputs: prompt, parameters: { max_length: 200, min_length: 140, no_repeat_ngram_size: 3, do_sample: false, early_stopping: true } },
